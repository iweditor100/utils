...
export default function UserInfoCard({ user }: UserInfoCardProps) {
  ...
  const handleSave = async () => {
    // Basic validation: name must not be empty if provided
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {'status' in user && typeof (user as Record<string, unknown>).status === 'string' 
                  ? (user as Record<string, unknown>).status as string 
                  : "Not available"}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {'emailVerifiedAt' in user && (user as Record<string, unknown>).emailVerifiedAt 
                  ? "Verified" 
                  : "Not verified"}
              </p>
            </div>
